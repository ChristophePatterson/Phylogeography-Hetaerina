...
## Load RAxML
system("module load bioinformatics")
system("module load raxml/8.2.12") 
system("module show raxml/8.2.12")
...
RunRaxml_v2(raxmlPath=RAXML_filepath, raxmlVersion="raxmlHPC-PTHREADS",inputPath=paste0(dir.path, "RAD_loci/"), mutationModel="GTRGAMMA", 
         iterations=2, seed=sample(1:10000000,1), outputSeeds=FALSE, discard=FALSE)