...
#SBATCH --array=1   # Create 32 tasks, numbers 1 to 32
...
# select number of samples to use - Can be no more than 5 in Hetaerina_all_ddRAD_titia_dg and no more than 7 in Hetaerina_all_ddRAD_americana_dg
case "$SNP_library" in
