...
#SBATCH --array=0-15   # Create 32 tasks, numbers 1 to 32

# Each separate task can be identified based on the SLURM_ARRAY_TASK_ID
# environment variable:

dir_path=(/nobackup/tmjj24/ddRAD/Durham_sequence_processing/trimmed_adapt_sw4-20_minlen15/)
OUT_DIR=(/nobackup/tmjj24/ddRAD/Durham_sequence_processing/filtered_clones_trimmed_adapt_sw4-20_minlen15/)
