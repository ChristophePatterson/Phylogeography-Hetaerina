...
dir_output=(/nobackup/tmjj24/ddRAD/Durham_sequence_processing/QC)
dir_output_raw=($dir_output/raw_multiqc_durham)
dir_output_trim=($dir_output/trim_multiqc_durham)
dir_output_clone=($dir_output/clone_multiqc_durham)
dir_output_demulti=($dir_output/demulti_multiqc_durham)

dir_raw=(/nobackup/tmjj24/ddRAD/RAW_Durham_data/All_fastq_files)
dir_trim=(/nobackup/tmjj24/ddRAD/Durham_sequence_processing/trimmed_adapt_sw4-20_minlen15/)
dir_clone=(/nobackup/tmjj24/ddRAD/Durham_sequence_processing/filtered_clones_trimmed_adapt_sw4-20_minlen15/)
dir_demulti=(/nobackup/tmjj24/ddRAD/Durham_sequence_processing/demultiplexed_filtered_clones_trimmed_adapt_sw4-20_minlen15_all)
