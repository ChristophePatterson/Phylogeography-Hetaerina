...
input_directory=(/nobackup/tmjj24/ddRAD/Pool_X_sequence_processing/filtered_clones_trimmed_adapt_sw4-20_minlen15/)
dir_output=(/nobackup/tmjj24/ddRAD/Pool_X_sequence_processing/demultiplexed/demultiplexed_filtered_clones_trimmed_adapt_sw4-20_minlen15_$SLURM_ARRAY_TASK_ID/)

mkdir -p $dir_output

# Creates vector of adapter barcodes

BARCODES=(/home/tmjj24/scripts/job_scripts/Master-demulitiplex-scripts/ddRAD_Pool_X/barcodes/*)
