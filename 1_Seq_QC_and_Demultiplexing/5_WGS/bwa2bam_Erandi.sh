...
#SBATCH --array=0-3  # Create 4 tasks, numbers 0 to 381
...
input_directory=(/nobackup/tmjj24/ddRAD/WGS_titia/data/Erandi)
dir_output=(/nobackup/tmjj24/ddRAD/WGS_titia/bam/Erandi)
