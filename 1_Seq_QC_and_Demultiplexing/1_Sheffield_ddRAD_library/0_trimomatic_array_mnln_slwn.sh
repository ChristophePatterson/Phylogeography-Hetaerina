...
dir_input=(/nobackup/tmjj24/ddRAD/RAW_sheffield_data/All_Sheffield_seq)
dir_output=(/nobackup/tmjj24/ddRAD/RAW_sheffield_data/All_Sheffield_seq/trimmed_adapt_sw4-20_minlen15)

mkdir -p $dir_output

cd $dir_input

FILES_1=(*R1_001.fastq.gz)
FILES_2=(*R2_001.fastq.gz)
