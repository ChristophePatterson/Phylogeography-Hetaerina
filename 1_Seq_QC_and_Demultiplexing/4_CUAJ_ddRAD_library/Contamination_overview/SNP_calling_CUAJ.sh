...
#SBATCH --array=1   # Create 6 tasks, numbers 1 to 6
...
bamFiles=(/home/tmjj24/scripts/Github/Thesis-Phylogeographic-Hetaerina/1_Seq_QC_and_Demultiplexing/4_CUAJ_ddRAD_library/Contamination_overview/CUAJ_Masters_library_bamfiles.txt)
