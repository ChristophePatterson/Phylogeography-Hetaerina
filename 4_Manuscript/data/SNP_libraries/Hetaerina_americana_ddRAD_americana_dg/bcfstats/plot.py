...
#   plot-vcfstats -p bcfstats Hetaerina_americana_ddRAD_americana_dg_bcfstats_snps.txt
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. Hetae .. Hetaerina_americana_ddRAD_americana_dg.all.snps.NOGTDP10.MEANGTDP10_200.Q60.SAMP0.8.MAF2.rand1000.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='Hetae')
    has_data = 1
