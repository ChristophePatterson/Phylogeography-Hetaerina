...
#   plot-vcfstats -p bcfstats Hetaerina_americana_ddRAD_titia_dg_bcfstats_snps.txt
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. Hetae .. Hetaerina_americana_ddRAD_titia_dg.all.snps.NOGTDP10.MEANGTDP10_200.Q60.SAMP0.8.MAF2.rand1000.vcf.gz
#
